    ...
    public partial class _3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameColumn(
                name: "Description",
                table: "ShipDefense",
                newName: "ShipDefenseId");

            migrationBuilder.CreateTable(
                name: "ShipDefenseObject",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipDefenseObject", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ShipWeaponObject",
                columns: table => new
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipWeaponObject", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipWeapon_ShipWeaponId",
                table: "ShipWeapon",
                column: "ShipWeaponId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ShipDefense_ShipDefenseId",
                table: "ShipDefense",
